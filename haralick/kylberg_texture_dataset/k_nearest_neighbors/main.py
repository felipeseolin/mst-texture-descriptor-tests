...
def main():
    arff_file = '../../../datasets/kylberg-texture-dataset/data/Haralick.arff'
    ...
    path_results = base_path_results + 'haralick/kylberg_texture_dataset/k_nearest_neighbors'

    content = f"====== HARALICK - K_NEAREST_NEIGHBORS - KYLBERG TEXTURE DATASET====== \n\n" \
              f"{len(x)} images\n\n" \
